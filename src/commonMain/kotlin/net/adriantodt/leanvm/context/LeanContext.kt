...
/**
 * A [net.adriantodt.leanvm.LeanMachine] context.
...
public interface LeanContext {
     ...
     *
     * This is used by [net.adriantodt.leanvm.LeanMachine] in order to handle platform exceptions.
     */
    public val runtime: LeanRuntime

    /**
     * Function called by [net.adriantodt.leanvm.LeanMachine] when the machine is ready to execute a new instruction.
     */
    public fun step()

    /**
     * Function called by [net.adriantodt.leanvm.LeanMachine] when the context pushed by this context finished executing
    ...
    /**
     * Function called by [net.adriantodt.leanvm.LeanMachine] when a stack trace is requested.
     ...
     *
     * This function should not call [net.adriantodt.leanvm.LeanMachine.stackTrace] or [LeanMachineControl.stackTrace]
